/*
 * Test Oracle Class for LookupTableLinear
...
public /*@ nullable_by_default */ class LookupTableLinear_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {LookupTableLinear_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(LookupTableLinear_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(LookupTableLinear.class),
   ...
   *
   * @param startValue The int to be passed.
   * @param range The int to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_LookupTableLinear__int_startValue__int_range__0")
  public void test_LookupTableLinear__int_startValue__int_range__0
  (final int startValue, final int range) {
    try {
      new LookupTableLinear(startValue, range);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_LookupTableLinear__int_startValue__int_range__0".equals($e.getStackTrace()[3].getMethodName())) {
   ...
   *
   * @param the_test_object The LookupTableLinear to call the test method on.
   * @param si The ScaleIndex to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_getValue__ScaleIndex_si__0")
  public void test_getValue__ScaleIndex_si__0
  (final LookupTableLinear the_test_object, 
   final ScaleIndex si) {
    ...
    try {
      the_test_object.getValue(si);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_getValue__ScaleIndex_si__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  /**
   * Data provider for constructor LookupTableLinear(int, int).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_LookupTableLinear__int_startValue__int_range__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_LookupTableLinear__int_startValue__int_range__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (LookupTableLinear_LookupTableLinear__int_startValue__int_range__0__startValue.class,
          LookupTableLinear_LookupTableLinear__int_startValue__int_range__0__range.class));
  }


  /**
   * Data provider for method int getValue(ScaleIndex).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_getValue__ScaleIndex_si__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_getValue__ScaleIndex_si__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (LookupTableLinear_InstanceStrategy.class,
          LookupTableLinear_getValue__ScaleIndex_si__0__si.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(LookupTableLinear_InstanceStrategy.class));
  }
}