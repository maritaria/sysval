/*
 * Test Oracle Class for IgnitionTest
...
public /*@ nullable_by_default */ class IgnitionTest_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {IgnitionTest_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(IgnitionTest_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(IgnitionTest.class),
   ...
   *
   * @param the_test_object The IgnitionTest to call the test method on.
   ...
   */
  @Test(dependsOnMethods = { "test_racEnabled" })
  public void test_IgnitionTest__0
  () {
    try {
      new IgnitionTest();
    }
      ...
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_IgnitionTest__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  public static IteratorWrapper<Object[]> p_main__String1DArray_args__10() {
    ...
    (new ParameterArrayIterator
         (IgnitionTest_main__String1DArray_args__10__args.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(IgnitionTest_InstanceStrategy.class));
  }
}