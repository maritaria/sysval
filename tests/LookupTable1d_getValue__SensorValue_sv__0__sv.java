 ...
 * of method "int getValue(SensorValue)". 
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2017-10-09 22:23 +0200
 */
public /*@ nullable_by_default */ class LookupTable1d_getValue__SensorValue_sv__0__sv
  extends LookupTable1d_ClassStrategy_SensorValue {
  /**
   ...
   * "SensorValue sv" of method "int getValue(SensorValue)" 
   ...
   */
  public LookupTable1d_getValue__SensorValue_sv__0__sv() {
    super();
