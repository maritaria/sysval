 ...
 */
public /*@ nullable_by_default */ class IgnitionTest_main__String1DArray_args__10__args
  extends IgnitionTest_ClassStrategy_java_lang_String1DArray {
  /**
   ...
   */
  public IgnitionTest_main__String1DArray_args__10__args() {
    super();
