/*
 * Test Oracle Class for IgnitionModule
...
public /*@ nullable_by_default */ class IgnitionModule_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {IgnitionModule_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(IgnitionModule_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(IgnitionModule.class),
   ...
   *
   * @param rpmSensor The SensorValue to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_IgnitionModule__SensorValue_rpmSensor__0")
  public void test_IgnitionModule__SensorValue_rpmSensor__0
  (final SensorValue rpmSensor) {
    try {
      new IgnitionModule(rpmSensor);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_IgnitionModule__SensorValue_rpmSensor__0".equals($e.getStackTrace()[3].getMethodName())) {
  ...
  /**
   * A test for method getIgnition.
   *
   * @param the_test_object The IgnitionModule to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_getIgnition__0
  (final IgnitionModule the_test_object ) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
        ("could not construct an object to test");
      }
    try {
      the_test_object.getIgnition();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_getIgnition__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  /**
   * Data provider for constructor IgnitionModule(SensorValue).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_IgnitionModule__SensorValue_rpmSensor__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_IgnitionModule__SensorValue_rpmSensor__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (IgnitionModule_IgnitionModule__SensorValue_rpmSensor__0__rpmSensor.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(IgnitionModule_InstanceStrategy.class));
  }
}